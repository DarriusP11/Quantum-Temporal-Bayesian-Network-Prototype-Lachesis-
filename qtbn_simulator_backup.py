...
tab_sv, tab_red, tab_meas, tab_fid, tab_presets, tab_present, tab_fx, tab_fin, tab_guide, tab_advanced_q, tab_qaoa, tab_sentiment, tab_prompt, tab_vqe = st.tabs(
    [
        "Statevector", "Reduced States", "Measurement", "Fidelity & Export",
        "Presets", "Present Scenarios", "Foresight", "Financial Analysis",
        "Lachesis Guide", "Advanced Quantum", "Toy QAOA", "Sentiment Analysis", "Prompt Studio", "VQE"
    ]
)
